...
public class SpheroidListBetterEnd extends SpheroidList {
    ...
    public static void setup(SpheroidLoader spheroidLoader) {
        ...
        SingleBlockDecorator CHORUS_GRASS_DECORATOR = new SingleBlockDecorator(chorus_grass, 0.25F);
        ...
        SingleBlockDecorator CRYSTAL_GRASS_DECORATOR = new SingleBlockDecorator(crystal_grass, 0.25F);
        ...
        SingleBlockDecorator BLUE_VINE_SEED_DECORATOR = new SingleBlockDecorator(blue_vine_seed, 0.1F);
        SingleBlockDecorator CREEPING_MOSS_DECORATOR = new SingleBlockDecorator(creeping_moss, 0.1F);
        SingleBlockDecorator UMBRELLA_MOSS_DECORATOR = new SingleBlockDecorator(umbrella_moss, 0.1F);
        TallFlowerBlockDecorator UMBRELLA_MOSS_TALL_DECORATOR = new TallFlowerBlockDecorator(umbrella_moss_tall, 0.05F);
        ...
        */
        ...
        SingleBlockDecorator SHADOW_PLANT_DECORATOR = new SingleBlockDecorator(shadow_plant, 0.2F);
        SingleBlockDecorator NEEDLEGRASS_DECORATOR = new SingleBlockDecorator(needlegrass, 0.1F);
        SingleBlockDecorator SHADOW_BERRY_DECORATOR = new SingleBlockDecorator(shadow_berry, 0.05F);
        SingleBlockDecorator MURKWEED_DECORATOR = new SingleBlockDecorator(murkweed, 0.05F);
        ...
        SingleBlockDecorator CAVE_GRASS_DECORATOR = new SingleBlockDecorator(cave_grass, 0.1F);
        SingleBlockDecorator CAVE_BUSH_DECORATOR = new SingleBlockDecorator(cave_bush, 0.3F);
        ...
        BottomBlockDecorator tenanea_flowers_decorator = new BottomBlockDecorator(tenanea_flowers, 0.1F);
        ...
        SingleBlockDecorator bushy_grass_decorator = new SingleBlockDecorator(bushy_grass, 0.6F);
        BlockState blossom_berry_seed = getDefaultBlockState(MOD_ID,"blossom_berry_seed");
        SingleBlockDecorator blossom_berry_seed_decorator = new SingleBlockDecorator(blossom_berry_seed, 0.05F);
        ...
        SingleBlockDecorator amber_grass_decorator = new SingleBlockDecorator(amber_grass, 0.6F);
        BlockState lanceleaf_seed = getDefaultBlockState(MOD_ID,"lanceleaf_seed");
        SingleBlockDecorator lanceleaf_seed_decorator = new SingleBlockDecorator(lanceleaf_seed, 0.05F);
        BlockState glowing_pillar_seed = getDefaultBlockState(MOD_ID,"glowing_pillar_seed");
        SingleBlockDecorator glowing_pillar_seed_decorator = new SingleBlockDecorator(glowing_pillar_seed, 0.05F);
        ...
        BottomBlockDecorator jungle_vine_decorator = new BottomBlockDecorator(jungle_vine, 0.2F);
        ...
        SingleBlockDecorator jungle_grass_decorator = new SingleBlockDecorator(jungle_grass, 0.2F);
        SingleBlockDecorator small_jellyshroom_decorator = new SingleBlockDecorator(small_jellyshroom, 0.2F);
        SingleBlockDecorator twisted_umbrella_moss_decorator = new SingleBlockDecorator(twisted_umbrella_moss, 0.2F);
        TallFlowerBlockDecorator twisted_umbrella_moss_tall_decorator = new TallFlowerBlockDecorator(twisted_umbrella_moss_tall, 0.1F);
        ...
        SingleBlockDecorator charnia_red_decorator = new SingleBlockDecorator(charnia_red, 0.2F);
        SingleBlockDecorator charnia_purple_decorator = new SingleBlockDecorator(charnia_purple, 0.2F);
        SingleBlockDecorator charnia_orange_decorator = new SingleBlockDecorator(charnia_orange, 0.2F);
        SingleBlockDecorator charnia_light_blue_decorator = new SingleBlockDecorator(charnia_light_blue, 0.2F);
        SingleBlockDecorator charnia_cyan_decorator = new SingleBlockDecorator(charnia_cyan, 0.2F);
        SingleBlockDecorator charnia_green_decorator = new SingleBlockDecorator(charnia_green, 0.2F);

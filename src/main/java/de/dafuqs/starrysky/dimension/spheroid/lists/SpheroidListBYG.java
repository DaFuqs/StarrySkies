...
import de.dafuqs.starrysky.dimension.decorators.BlockStackDecorator;
...
public class SpheroidListBYG extends SpheroidList {
    ...
    private static void setupOverworld(SpheroidLoader spheroidLoader) {
        ...
        SingleBlockDecorator byg_blueberry_bush_decorator = new SingleBlockDecorator(byg_blueberry_bush, 0.05F); // MEADOW_GRASSBLOCK, OVERGROWN_DACITE, OVERGROWN_STONE, GRASS_BLOCK
        SingleBlockDecorator byg_mini_cactus_decorator = new SingleBlockDecorator(byg_mini_cactus, 0.03F);
        SingleBlockDecorator byg_golden_spined_cactus_decorator = new SingleBlockDecorator(byg_golden_spined_cactus, 0.1F);
        SingleBlockDecorator byg_prickly_pear_cactus_decorator = new SingleBlockDecorator(byg_prickly_pear_cactus, 0.05F);
        SingleBlockDecorator byg_winter_succulent_decorator = new SingleBlockDecorator(byg_winter_succulent, 0.07F);
        SingleBlockDecorator byg_winter_grass_decorator = new SingleBlockDecorator(byg_winter_grass, 0.05F);

        SingleBlockDecorator byg_prairie_grass_decorator = new SingleBlockDecorator(byg_prairie_grass, 0.2F);
        SingleBlockDecorator byg_beach_grass_decorator = new SingleBlockDecorator(byg_beach_grass, 0.1F);
        SingleBlockDecorator byg_small_beach_grass_decorator = new SingleBlockDecorator(byg_short_beach_grass, 0.1F);
        TallFlowerBlockDecorator byg_tall_prairie_grass_decorator = new TallFlowerBlockDecorator(byg_tall_prairie_grass, 0.2F);
    ...
    private static void setupNether(SpheroidLoader spheroidLoader) {
        ...
        SingleBlockDecorator BORIC_FIRE_DECORATOR = new SingleBlockDecorator(boric_fire, 0.05F);
        ...
        TallFlowerBlockDecorator TALL_EMBUR_ROOTS_DECORATOR = new TallFlowerBlockDecorator(tall_embur_roots, 0.05F);
        SpheroidType CRIMSON_GARDENS = new ModularSpheroidType(null, 7, 12, Blocks.BLACKSTONE.getDefaultState())
                ...
                .addDecorator(SpheroidListVanilla.SpheroidDecorators.MUSHROOMS_BROWN, 0.5F)
                .addDecorator(SpheroidListVanilla.SpheroidDecorators.MUSHROOMS_RED, 0.5F)
                .addDecorator(SpheroidListVanillaNether.SpheroidDecorators.CRIMSON_ROOTS, 0.5F)
        ...
        BottomBlockStackDecorator WEEPING_ROOTS_PLANT_DECORATOR = new BottomBlockStackDecorator(weeping_roots_plant, 0.09F, 1, 7);
        ...
        SingleBlockDecorator QUARTZ_CRYSTAL_DECORATOR = new SingleBlockDecorator(quartz_crystal, 0.1F);

        BlockState hanging_bones = getDefaultBlockState(MOD_ID,"hanging_bones");
        BottomBlockStackDecorator HANGING_BONES_DECORATOR = new BottomBlockStackDecorator(hanging_bones, 0.05F, 2, 5);
        ...
        SpheroidType QUARTZ_DESERT = new ShellSpheroidType(null, 10, 16, raw_quartz_block, quartzite_sand, 2, 4)
                ...
                .addDecorator(SpheroidListVanilla.SpheroidDecorators.MUSHROOMS_BROWN, 0.25F)
                .addDecorator(SpheroidListVanilla.SpheroidDecorators.MUSHROOMS_RED, 0.25F)
        ...
        BottomBlockStackDecorator HANGING_SYTHIAN_ROOTS_DECORATOR = new BottomBlockStackDecorator(hanging_sythian_roots_plant, 0.1F, 2, 6).setLastBlockState(hanging_sythian_roots);
        ...
        SingleBlockDecorator SYTHIAN_SPROUT_DECORATOR = new SingleBlockDecorator(sythian_sprout, 0.1F);
        ...
        BottomBlockStackDecorator SOUL_SHROOM_SPORE_DECORATOR = new BottomBlockStackDecorator(soul_shroom_spore, 0.1F, 2, 5).setLastBlockState(soul_shroom_spore_end);
        ...
        BlockStackDecorator WARPED_CACTUS_DECORATOR = new BlockStackDecorator(warped_cactus, 0.05F, 1, 3).requiresAirAroundOfIt();
        BlockState warped_coral = getDefaultBlockState(MOD_ID,"warped_coral");
        SingleBlockDecorator WARPED_CORAL_DECORATOR = new SingleBlockDecorator(warped_coral, 0.05F);
        BlockState warped_coral_fan = getDefaultBlockState(MOD_ID,"warped_coral_fan");
        SingleBlockDecorator WARPED_CORAL_FAN_DECORATOR = new SingleBlockDecorator(warped_coral_fan, 0.02F);
        ...
        SingleBlockDecorator WHALING_GRASS_DECORATOR = new SingleBlockDecorator(whaling_grass, 0.1F);
        BlockState scorched_bush = getDefaultBlockState(MOD_ID,"scorched_bush");
        SingleBlockDecorator SCORCHED_BUSH_DECORATOR = new SingleBlockDecorator(scorched_bush, 0.05F);
        BlockState scorched_grass = getDefaultBlockState(MOD_ID,"scorched_grass");
        SingleBlockDecorator SCORCHED_GRASS_DECORATOR = new SingleBlockDecorator(scorched_grass, 0.1F);
        ...
        BottomBlockStackDecorator LAMENT_VINE_DECORATOR = new BottomBlockStackDecorator(lament_vine_plant, 0.1F, 2, 5).setLastBlockState(lament_vine);
        ...
        SingleBlockDecorator DEATH_CAP_DECORATOR = new SingleBlockDecorator(death_cap, 0.09F);
    ...
    private static void setupEnd(SpheroidLoader spheroidLoader) {
        ...
        BlockStackDecorator ODDITY_CACTUS_DECORATOR = new BlockStackDecorator(oddity_cactus, 0.05F, 1, 3).requiresAirAroundOfIt();
        BlockState oddity_bush = getDefaultBlockState(MOD_ID,"oddity_bush"); // plant
        SingleBlockDecorator ODDITY_BUSH_DECORATOR = new SingleBlockDecorator(oddity_bush, 0.02F);
        ...
        SingleBlockDecorator NIGHTSHADE_SPROUTS_DECORATOR = new SingleBlockDecorator(nightshade_sprouts, 0.2F);
        BlockState nightshade_roots = getDefaultBlockState(MOD_ID,"nightshade_roots"); // double plant
        TallFlowerBlockDecorator NIGHTSHADE_ROOTS_DECORATOR = new TallFlowerBlockDecorator(nightshade_roots, 0.1F);
        ...
        SingleBlockDecorator IVIS_ROOTS_DECORATOR = new SingleBlockDecorator(ivis_roots, 0.15F);
        BlockState ether_bush = getDefaultBlockState(MOD_ID,"ether_bush");
        SingleBlockDecorator ETHER_BUSH_DECORATOR = new SingleBlockDecorator(ether_bush, 0.04F);
        ...
        SingleBlockDecorator CRYPTIC_FIRE_DECORATOR = new SingleBlockDecorator(cryptic_fire, 0.15F);
        BlockState scorched_bush = getDefaultBlockState(MOD_ID,"scorched_bush");
        SingleBlockDecorator SCORCHED_BUSH_DECORATOR = new SingleBlockDecorator(scorched_bush, 0.1F);
        BlockState scorched_grass = getDefaultBlockState(MOD_ID,"scorched_grass");
        SingleBlockDecorator SCORCHED_GRASS_DECORATOR = new SingleBlockDecorator(scorched_grass, 0.05F);
        ...
        SingleBlockDecorator THEREAL_BELLFOWER_DECORATOR = new SingleBlockDecorator(thereal_bellflower, 0.03F);
        BlockState ether_grass = getDefaultBlockState(MOD_ID,"ether_grass");
        SingleBlockDecorator ETHER_GRASS_DECORATOR = new SingleBlockDecorator(ether_grass, 0.15F);
        ...
        SingleBlockDecorator VERMILION_SCULK_GROWTH_DECORATOR = new SingleBlockDecorator(vermilion_sculk_growth, 0.15F);
        BlockState therium_crystal = getDefaultBlockState(MOD_ID,"therium_crystal");
        SingleBlockDecorator THERIUM_CRYSTAL_DECORATOR = new SingleBlockDecorator(therium_crystal, 0.1F);
        ...
        SingleBlockDecorator SHULKREN_FUNGUS_DECORATOR = new SingleBlockDecorator(shulkren_fungus, 0.05F);
        ...
        BottomBlockStackDecorator SHULKREN_VINE_DECORATOR = new BottomBlockStackDecorator(shulkren_vine_plant, 0.1F, 2, 6).setLastBlockState(shulkren_vine);

...
import de.dafuqs.starrysky.dimension.spheroid.types.unique.NetherFortressSpheroidType;
...
public class SpheroidListVanillaNether extends SpheroidList {
	...
	public static class SpheroidDecorators {
        public static SpheroidDecorator NETHER_WART = new SingleBlockDecorator(Blocks.NETHER_WART.getDefaultState(), 0.02F);
        public static SpheroidDecorator FIRE = new SingleBlockDecorator(Blocks.FIRE.getDefaultState(), 0.1F);
        public static SpheroidDecorator SOUL_FIRE = new SingleBlockDecorator(Blocks.SOUL_FIRE.getDefaultState(), 0.1F);
        public static SpheroidDecorator CRIMSON_ROOTS = new SingleBlockDecorator(Blocks.CRIMSON_ROOTS.getDefaultState(), 0.1F);
        public static SpheroidDecorator WARPED_ROOTS = new SingleBlockDecorator(Blocks.WARPED_ROOTS.getDefaultState(), 0.1F);
        public static SpheroidDecorator NETHER_SPROUTS = new SingleBlockDecorator(Blocks.NETHER_SPROUTS.getDefaultState(), 0.1F);
        public static SpheroidDecorator CRIMSON_FUNGUS = new SingleBlockDecorator(Blocks.CRIMSON_FUNGUS.getDefaultState(), 0.05F);
        public static SpheroidDecorator WARPED_FUNGUS = new SingleBlockDecorator(Blocks.WARPED_FUNGUS.getDefaultState(), 0.05F);
        public static SpheroidDecorator TWISTING_VINES = new BlockStackDecorator(Blocks.TWISTING_VINES_PLANT.getDefaultState(), 0.05F, 1, 6).setLastBlockState(Blocks.TWISTING_VINES.getDefaultState()); // warped, grow upward
        public static SpheroidDecorator WEEPING_VINES = new BottomBlockStackDecorator(Blocks.WEEPING_VINES_PLANT.getDefaultState(), 0.1F, 1, 6).setLastBlockState(Blocks.WEEPING_VINES.getDefaultState()); // crimson, growing downwards
	}
    ...
    public static final SpheroidType NETHERRACK = new ModularSpheroidType(SpheroidAdvancementIdentifier.netherrack, 7, 16,  Blocks.NETHERRACK.getDefaultState())
			...
			.addDecorator(SpheroidListVanilla.SpheroidDecorators.MUSHROOMS_BROWN, 0.3F)
			.addDecorator(SpheroidListVanilla.SpheroidDecorators.MUSHROOMS_RED, 0.3F)
    ...
    public static final SpheroidType MAGMA_BLOCK = new ModularSpheroidType(SpheroidAdvancementIdentifier.magma, 5, 8,  Blocks.MAGMA_BLOCK.getDefaultState())
			...
			.addDecorator(SpheroidListVanilla.SpheroidDecorators.CENTER_POND_LAVA, 0.15F);
	...
	public static final SpheroidType BASALT = new ModularSpheroidType(SpheroidAdvancementIdentifier.basalt, 10, 25,  Blocks.BASALT.getDefaultState())
			.addDecorator(SpheroidListVanilla.SpheroidDecorators.CENTER_POND_LAVA, 0.08F);

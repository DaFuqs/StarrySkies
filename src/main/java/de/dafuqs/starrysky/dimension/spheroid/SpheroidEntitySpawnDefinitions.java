package de.dafuqs.starrysky.dimension.spheroid;
...
public class SpheroidEntitySpawnDefinitions {
    ...
    public static SpheroidEntitySpawnDefinition DONKEY = new SpheroidEntitySpawnDefinition(EntityType.DONKEY, 1, 3);
    public static SpheroidEntitySpawnDefinition FOX = new SpheroidEntitySpawnDefinition(EntityType.FOX, 1, 2);
    public static SpheroidEntitySpawnDefinition HORSE = new SpheroidEntitySpawnDefinition(EntityType.HORSE, 1, 3);
    public static SpheroidEntitySpawnDefinition MOOSHROOM = new SpheroidEntitySpawnDefinition(EntityType.MOOSHROOM, 1, 3);
    public static SpheroidEntitySpawnDefinition MULE = new SpheroidEntitySpawnDefinition(EntityType.MULE, 1, 2);
    public static SpheroidEntitySpawnDefinition OCELOT = new SpheroidEntitySpawnDefinition(EntityType.OCELOT, 1, 2);
    public static SpheroidEntitySpawnDefinition PARROT = new SpheroidEntitySpawnDefinition(EntityType.PARROT, 2, 2);

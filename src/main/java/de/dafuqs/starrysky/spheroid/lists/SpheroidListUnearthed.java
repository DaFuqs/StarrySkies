...
public class SpheroidListUnearthed extends SpheroidList {
    ...
    public static void setup(SpheroidLoader spheroidLoader) {
        ...
        for(String stone : stones) {
            ...
            spheroidLoader.registerSpheroidType(SpheroidDistributionType.ORE, 0.9F,  new CoreSpheroidType(SpheroidAdvancementIdentifier.coal, 5, 15, Registry.BLOCK.get(new Identifier(MOD_ID,stone + "_coal_ore")).getDefaultState(), stoneBlockState, 4, 8)); // works?
            spheroidLoader.registerSpheroidType(SpheroidDistributionType.ORE, 0.5F,  new CoreSpheroidType(SpheroidAdvancementIdentifier.iron, 5, 12, Registry.BLOCK.get(new Identifier(MOD_ID,stone + "_iron_ore")).getDefaultState(), stoneBlockState, 3, 5));
            ...
            spheroidLoader.registerSpheroidType(SpheroidDistributionType.ORE, 0.4F,  new CoreSpheroidType(SpheroidAdvancementIdentifier.redstone, 5, 15, Registry.BLOCK.get(new Identifier(MOD_ID,stone + "_redstone_ore")).getDefaultState(), stoneBlockState, 4, 8)); // broken?

...
public class DecoratorFeatures {
    ...
    public static String SPHEROID_DECORATOR = "starry_sky_spheroid_decorator";
    public static Identifier SPHEROID_DECORATOR_ID = new Identifier(StarrySkyCommon.MOD_ID, SPHEROID_DECORATOR);
    ...
    static @NotNull String locate(String name){
        return StarrySkyCommon.MOD_ID + ':' + name;
    }

...
public class SpheroidListTechReborn extends SpheroidList {
    ...
    // Overworld
    private static final BlockState techreborn_bauxite_ore = Registry.BLOCK.get(new Identifier("techreborn","bauxite_ore")).getDefaultState();
    private static final BlockState techreborn_copper_ore = Registry.BLOCK.get(new Identifier("techreborn","copper_ore")).getDefaultState();
    private static final BlockState techreborn_galena_ore = Registry.BLOCK.get(new Identifier("techreborn","galena_ore")).getDefaultState();
    private static final BlockState techreborn_iridium_ore = Registry.BLOCK.get(new Identifier("techreborn","iridium_ore")).getDefaultState();
    private static final BlockState techreborn_lead_ore = Registry.BLOCK.get(new Identifier("techreborn","lead_ore")).getDefaultState();
    private static final BlockState techreborn_ruby_ore = Registry.BLOCK.get(new Identifier("techreborn","ruby_ore")).getDefaultState();
    private static final BlockState techreborn_sapphire_ore = Registry.BLOCK.get(new Identifier("techreborn","sapphire_ore")).getDefaultState();
    private static final BlockState techreborn_silver_ore = Registry.BLOCK.get(new Identifier("techreborn","silver_ore")).getDefaultState();
    private static final BlockState techreborn_tin_ore = Registry.BLOCK.get(new Identifier("techreborn","tin_ore")).getDefaultState();

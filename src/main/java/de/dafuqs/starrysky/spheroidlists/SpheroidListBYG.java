...
public class SpheroidListBYG extends SpheroidList {
    ...
    public static void setup(SpheroidLoader spheroidLoader) {
        ...
        // WOOD USING OAK LOGS
        spheroidLoader.registerSpheroidType(SpheroidDistributionType.WOOD, 0.8F, new ShellSpheroidType(null, 6, 8, Blocks.OAK_LOG.getDefaultState(), byg_joshua_leaves, 1, 1).addShellSpeckles(byg_ripe_joshua_leaves, 0.1F));
        spheroidLoader.registerSpheroidType(SpheroidDistributionType.WOOD, 1.0F, new ShellSpheroidType(null, 7, 14, Blocks.OAK_LOG.getDefaultState(), byg_orchard_leaves, 2, 3).addShellSpeckles(byg_flowering_orchard_leaves, 0.2F));
        ...
        spheroidLoader.registerSpheroidType(SpheroidDistributionType.DECORATIVE, 0.5F, new ModularSpheroidType(null, 5, 14, byg_meadow_dirt).setTopBlockState(byg_meadow_grass_block));
        spheroidLoader.registerSpheroidType(SpheroidDistributionType.DECORATIVE, 0.5F, new ModularSpheroidType(null, 8, 14, byg_dacite).setTopBlockState(byg_overgrown_dacite));
        spheroidLoader.registerSpheroidType(SpheroidDistributionType.DECORATIVE, 0.5F, new ModularSpheroidType(null, 8, 12, byg_dacite).setTopBlockState(byg_podzol_dacite).addDecorator(SpheroidDecorators.BAMBOO, 0.2F));

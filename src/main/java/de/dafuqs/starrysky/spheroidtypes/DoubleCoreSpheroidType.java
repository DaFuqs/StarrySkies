...
public class DoubleCoreSpheroidType extends SpheroidType {
    ...
    public DoubleCoreSpheroidType(SpheroidAdvancementIdentifier spheroidAdvancementIdentifier, BlockState innerCoreBlock, BlockState outerCoreBlock, BlockState shellBlock, int minSize, int maxSize, int minInnerCoreRadius, int maxInnerCoreRadius, int minShellRadius, int maxShellRadius) {
        this(spheroidAdvancementIdentifier, innerCoreBlock, outerCoreBlock, new HashMap<BlockState, Float>(){{put(shellBlock, 1.0F);}}, minSize, maxSize, minInnerCoreRadius, maxInnerCoreRadius,  minShellRadius, maxShellRadius);
    }

    public DoubleCoreSpheroidType(SpheroidAdvancementIdentifier spheroidAdvancementIdentifier,BlockState innerCoreBlock, BlockState outerCoreBlock, HashMap<BlockState, Float> validShellBlocks, int minSize, int maxSize, int minInnerCoreRadius, int maxInnerCoreRadius, int minShellRadius, int maxShellRadius) {

...
import de.dafuqs.starryskies.mixin.BlockStateProviderInvoker;
...
public class SphereStateProvider {
    ...
    public static final MapCodec<BlockStateProvider> BLOCK_STATE_PROVIDER_MAP_CODEC = BuiltInRegistries.BLOCKSTATE_PROVIDER_TYPE.byNameCodec().dispatchMap(provider -> ((BlockStateProviderInvoker) provider).invokeType(), BlockStateProviderType::codec);

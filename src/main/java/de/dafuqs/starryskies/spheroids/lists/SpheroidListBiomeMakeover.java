...
public class SpheroidListBiomeMakeover {
	
	private static final String MOD_ID = "biomemakeover";
	
	
	public static boolean shouldGenerate() {
		return FabricLoader.getInstance().isModLoaded(MOD_ID) && StarrySkies.CONFIG.generateBiomeMakeoverSpheroids;
	}
	
	public static void setup(SpheroidTemplateLoader spheroidLoader) {
		StarrySkies.log(INFO, "Loading Biome Makeover integration...");

...
public class SpheroidListBYG extends SpheroidList {
	...
	public static boolean shouldGenerate() {
		return FabricLoader.getInstance().isModLoaded(MOD_ID) && StarrySkies.CONFIG.generateBYGSpheroids;
	}
	
	public static void setup(SpheroidTemplateLoader spheroidLoader) {
		StarrySkies.log(INFO, "Loading BYG integration...");
	...
	private static void setupOverworld(SpheroidTemplateLoader spheroidLoader) {
		// VERY RARE ORES

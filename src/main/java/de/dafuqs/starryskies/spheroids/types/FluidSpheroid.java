...
public class FluidSpheroid extends Spheroid {
	...
	public static class Template extends Spheroid.Template {
		...
		public FluidSpheroid generate(ChunkRandom random) {
			...
			int coreRadius = Support.getRandomBetween(random, this.minShellRadius, this.maxShellRadius);
			...
			return new FluidSpheroid(this, randomBetween(random, minSize, maxSize), selectDecorators(random), selectSpawns(random), random, fluidBlockState, shellBlock.get(random), shellRadius, fillAmount, holeInBottom, coreBlock, coreRadius);
		}

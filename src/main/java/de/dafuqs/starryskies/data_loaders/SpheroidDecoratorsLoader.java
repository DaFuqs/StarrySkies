...
public class SpheroidDecoratorsLoader extends JsonDataLoader implements IdentifiableResourceReloadListener {
	
	public static final String ID = "starry_skies/decorators";
	public static final SpheroidDecoratorsLoader INSTANCE = new SpheroidDecoratorsLoader();
	
	protected SpheroidDecoratorsLoader() {
		super(new Gson(), ID);
	}

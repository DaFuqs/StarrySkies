...
public class SpheroidWeightedBlockLoader extends JsonDataLoader implements IdentifiableResourceReloadListener {
	
	public static final String ID = "starry_skies/weighted_block";
	public static final SpheroidWeightedBlockLoader INSTANCE = new SpheroidWeightedBlockLoader();
	
	protected SpheroidWeightedBlockLoader() {
		super(new Gson(), ID);
	}
